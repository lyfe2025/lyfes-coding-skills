...
def _domain_keywords():
    ...
    _DOMAIN_KEYWORDS = {
        ...
        "web": ["aria", "focus", "outline", "semantic", "virtualize", "autocomplete", "form", "input type", "preconnect", "html"],
        "app": ["ios", "android", "mobile app", "native app", "tab bar", "safe area", "react native", "app interface"]
    }
    return _DOMAIN_KEYWORDS
...
_DOMAIN_TIEBREAK_ORDER = [
    ...
    "chart", "landing", "icons", "gsap", "react", "web", "app",
]
